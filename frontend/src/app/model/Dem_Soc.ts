export class Dem_Soc {
    dem_socnum: Number;

    dem_denomination:String;
    dem_typetitulaire:String;
    dem_clienttitulaire:String;
    dem_typesociete:Number;
    dem_capitalsocial: Number;
    dem_nomprenomsdg: String;
    dem_adresse1: String;
    dem_adresse2: String;
    dem_ville: String;
    ...
    dem_siteinternet: String;
    dem_emailsociete: String;
    dem_emaildirigeant: String;
    dem_contactsociete: String;
