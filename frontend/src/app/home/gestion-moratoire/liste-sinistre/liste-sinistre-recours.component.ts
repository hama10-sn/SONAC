...
@Component({
  selector: 'ngx-liste-sinistre-recours',
  templateUrl: './liste-sinistre-recours.component.html',
  styleUrls: ['./liste-sinistre-recours.component.scss']
})
export class ListeSinistreRecoursComponent implements OnInit {
  ...
  onGetAllSinistresRecours() {
    this.sinistreService.getAllRecoursSinistre()
      .subscribe((data: any) => {
  ...
  onOpen(dialog: TemplateRef<any>, sinistre: Sinistre) {
    ...
    this.sinistreService.getMoratoireBySinistre(sinistre.sini_num)
      .subscribe((data: any) => {
        this.moratoire = data.data;
      })
  }

  onAddMoratoire(sinistre: any) {
    this.transfertData.setData(sinistre);
    this.router.navigateByUrl("/home/gestion-moratoire/ajouter-moratoire");
  }

  onModifierMoratoire(sinistre: Sinistre) {
    this.sinistreService.getMoratoireBySinistre(sinistre.sini_num)
      .subscribe((data: any) => {
        this.moratoire = data.data;
        this.transfertData.setData(this.moratoire);
        this.router.navigateByUrl("/home/gestion-moratoire/modifier-moratoire");
      })
  }

  onAnnulerMoratoire(sinistre: Sinistre) {
    this.transfertData.setData(sinistre);
    this.router.navigateByUrl("/home/gestion-moratoire/annuler-moratoire");
  }

  onEncaisserMoratoire(sinistre: Sinistre) {
    this.transfertData.setData(sinistre);
    this.router.navigateByUrl("/home/gestion-moratoire/encaisser-moratoire");
  }

  onAddPenalite(sinistre: Sinistre) {
    this.transfertData.setData(sinistre);
    this.router.navigateByUrl("/home/gestion-moratoire/ajouter-penalite");
  }

  onEncaisserPenalite(sinistre: Sinistre) {
    this.transfertData.setData(sinistre);
