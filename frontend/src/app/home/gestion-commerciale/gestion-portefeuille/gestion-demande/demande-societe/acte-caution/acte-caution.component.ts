...
@Component({
  selector: 'ngx-acte-caution',
  templateUrl: './acte-caution.component.html',
  styleUrls: ['./acte-caution.component.scss']
})
export class ActeCautionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(data!=null){
      ...
      this.montant1 = this.formatNumer( this.demandeSociete.dem_montant);
      if(this.demandeSociete.dem_produitdemande2!=0){
        this.montant2 = this.formatNumer( this.demandeSociete.dem_montant2);
      }
      if(this.demandeSociete.dem_produitdemande3!=0) {
        this.montant3 = this.formatNumer( this.demandeSociete.dem_montant3);
      }     
      this.montant_lettre = this.demandeSociete.dem_montant
    ...
    if(this.demandeSociete.dem_produitdemande2!=0){
      ...
      if(this.demandeSociete.dem_produitdemande2==15001001){
...
this.onGetByNumDamandeTypeDemandeTypeProduit(this.demandeSociete.dem_socnum,"societe");
  ...
  onExportActeAvanceDemarrage(demande:Dem_Soc) {
    ...
    if(this.demandeSociete.dem_produitdemande1==15001002){
      form.append("montant_demande", this.montant1);
		  form.append("montant_lettre", this.demandeSociete.dem_montant.toString());
    }else  if(this.demandeSociete.dem_produitdemande2==15001002){
      form.append("montant_demande", this.montant2);
		  form.append("montant_lettre", this.demandeSociete.dem_montant2.toString());
    }else  if(this.demandeSociete.dem_produitdemande3==15001002){
      form.append("montant_demande", this.montant3);
		  form.append("montant_lettre", this.demandeSociete.dem_montant3.toString());
    }
		//form.append("montant_demande", this.montant1);
		//form.append("montant_lettre", this.demandeSociete.dem_montant.toString());
...
console.log(form);
    ...
    this.demSocService.generateReportActeAd(demande.dem_socnum,form)
  ...
  onExportActeAvanceDemarragebis(demande:Dem_Soc) {
    this.titre=this.addForm.get("acte_titre").value
   this.dao=this.addForm.get("acte_dao").value
   this.beneficiaire =this.addForm.get("acte_beneficiaire").value
   this.date = this.datePipe.transform(this.addForm.get("acte_date").value,'dd/MM/yyyy').toString()
...
console.log(form);
  ...
  onExportActeSoumission(demande:Dem_Soc) {
   ...
   this.addForm2.controls['acte_dem_num'].setValue(this.demandeSociete.dem_socnum);
   this.addForm2.controls['acte_type_dem'].setValue("societe");
...
console.log(form);
   //let typesociete = this.listTypeSociete.find(p=>p.id==this.raisonsociale).value;
   // this.clientService.generateReportClient(format, title, this.demandeur)
   this.demSocService.generateReportActesoumission(demande.dem_socnum,form)
   //this.demSocService.generateReportInstruction(demande.dem_socnum,this.demandeur,this.raisonsociale,this.anneerelation,15000,15001,15002,15003,"mareme")
     .subscribe(event => {
       let message=""
       switch (event.type) {
 ...
 onExportActeSoumissionbis(demande:Dem_Soc) {
  this.titre=this.addForm2.get("acte_titre").value
  this.dao=this.addForm2.get("acte_dao").value
  this.beneficiaire =this.addForm2.get("acte_beneficiaire").value
  this.date = this.datePipe.transform(this.addForm2.get("acte_date").value,'dd/MM/yyyy').toString()
...
console.log(form);
 ...
 onExportActeDefinive(demande:Dem_Soc) {
 ...
 this.addForm3.controls['acte_dem_num'].setValue(this.demandeSociete.dem_socnum);
 this.addForm3.controls['acte_type_dem'].setValue("societe");
...
console.log(form);
 //let typesociete = this.listTypeSociete.find(p=>p.id==this.raisonsociale).value;
 // this.clientService.generateReportClient(format, title, this.demandeur)
 this.demSocService.generateReportActedefinitive(demande.dem_socnum,form)
 //this.demSocService.generateReportInstruction(demande.dem_socnum,this.demandeur,this.raisonsociale,this.anneerelation,15000,15001,15002,15003,"mareme")
   .subscribe(event => {
     let message=""
     switch (event.type) {
...
onExportActeDefinivebis(demande:Dem_Soc) {
  this.titre=this.addForm3.get("acte_titre").value
  this.dao=this.addForm3.get("acte_dao").value
  this.beneficiaire =this.addForm3.get("acte_beneficiaire").value
  this.date = this.datePipe.transform(this.addForm3.get("acte_date").value,'dd/MM/yyyy').toString()
...
onExportActeBonneExecution(demande:Dem_Soc) {
  ...
  this.addForm4.controls['acte_dem_num'].setValue(this.demandeSociete.dem_socnum);
  this.addForm4.controls['acte_type_dem'].setValue("societe");
...
console.log(form);
  //let typesociete = this.listTypeSociete.find(p=>p.id==this.raisonsociale).value;
  // this.clientService.generateReportClient(format, title, this.demandeur)
  this.demSocService.generateReportActeBonneExecution(demande.dem_socnum,form)
  //this.demSocService.generateReportInstruction(demande.dem_socnum,this.demandeur,this.raisonsociale,this.anneerelation,15000,15001,15002,15003,"mareme")
    .subscribe(event => {
      let message=""
      switch (event.type) {
  ...
  onExportActeBonneExecutionbis(demande:Dem_Soc) {
    this.titre=this.addForm4.get("acte_titre").value
    this.dao=this.addForm4.get("acte_dao").value
    this.beneficiaire =this.addForm4.get("acte_beneficiaire").value
    this.date = this.datePipe.transform(this.addForm4.get("acte_date").value,'dd/MM/yyyy').toString()
  ...
  onExportActeRetenueGarantie(demande:Dem_Soc) {
    ...
    this.addForm5.controls['acte_dem_num'].setValue(this.demandeSociete.dem_socnum);
    this.addForm5.controls['acte_type_dem'].setValue("societe");
   ...
   console.log(form);
    //let typesociete = this.listTypeSociete.find(p=>p.id==this.raisonsociale).value;
    // this.clientService.generateReportClient(format, title, this.demandeur)
    this.demSocService.generateReportActeRetenueGarantie(demande.dem_socnum,form)
    //this.demSocService.generateReportInstruction(demande.dem_socnum,this.demandeur,this.raisonsociale,this.anneerelation,15000,15001,15002,15003,"mareme")
      .subscribe(event => {
        let message=""
        switch (event.type) {
   ...
   onExportActeRetenueGarantiebis(demande:Dem_Soc) {
    this.titre=this.addForm5.get("acte_titre").value
    this.dao=this.addForm5.get("acte_dao").value
    this.beneficiaire =this.addForm5.get("acte_beneficiaire").value
    this.date = this.datePipe.transform(this.addForm5.get("acte_date").value,'dd/MM/yyyy').toString()
