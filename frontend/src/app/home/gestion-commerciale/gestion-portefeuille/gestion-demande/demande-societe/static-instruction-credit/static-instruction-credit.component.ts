...
@Component({
  selector: 'ngx-static-instruction-credit',
  templateUrl: './static-instruction-credit.component.html',
  styleUrls: ['./static-instruction-credit.component.scss']
})
export class StaticInstructionCreditComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,private transfertData: TransfertDataService,private demSocService:DemandesocieteService,
    ...
    private produitService : ProduitService,private secteurService: ClassificationSecteurService,
  ...
  ngOnInit(): void {
    ...
    if(data!=null){
      ...
      if(this.demandeSociete.dem_typetitulaire=="CL"){
        ...
        console.log("prospect",this.demandeSociete.dem_typetitulaire);
        this.anneerelation = this.datePipe.transform(this.prospect.prospc_date_relation,'yyyy');
        this.nomgerant=this.prospect.prospc_princdirigeant;
        this.denomminationsociale=this.prospect.prospc_denomination;
    ...
    this.c1=this.demandeSociete.dem_produitdemande1;
    ...
    this.addForm.controls['instruct_encours_demande'].setValue(this.demandeSociete.dem_montant);
    ...
    //this.c2= (this.produitss.find(p => p.prod_numero == this.demandeSociete.dem_produitdemande1))?.prod_denominationlong
    this.onGetAllInstructionByDemandeTypeDemande(this.demandeSociete.dem_socnum,"societe");
  }
  ...
  onExportConditionInstruction(demande:Dem_Soc) {
    ...
    this.montantavenant=this.demandeSociete.dem_montant;
    ...
    //this.policenumero = this.addForm.get("instruct_police").value+"/"+ this.demandeSociete.dem_socnum;
    ...
    this.soumissionencours=this.demandeSociete.dem_montant,
    ...
    this.ml1=this.addForm.get("instruct_taux").value*this.demandeSociete.dem_montant/100 ;
    this.c3=this.demandeSociete.dem_montant- this.addForm.get("instruct_taux").value*this.demandeSociete.dem_montant/100 ;;
    ...
    this.demandeSociete.dem_montant2=this.addForm.get("instruct_duree_credit").value;
    this.demandeSociete.dem_montant3=this.addForm.get("instruct_condition_paiement").value;
    ...
    this.addForm.controls['instruct_demande'].setValue(this.demandeSociete.dem_socnum)
    this.addForm.controls['instruct_type'].setValue('credit')
    this.addForm.controls['instruct_type_dem'].setValue('societe')
    ...
    this.aviscommerciale=this.demandeSociete.dem_commentaire1;
    ...
    form.append("montantavenent2", this.formatNumberService.numberWithCommas2(this.demandeSociete.dem_montant2));
		form.append("montantavenent3", this.formatNumberService.numberWithCommas2(this.demandeSociete.dem_montant3));
...
console.log(form);
    ...
    let message=""
    this.demSocService.generateReportInstructionCredit1(demande.dem_socnum,form)
...
onExportInstruction(demande:Dem_Soc) {
...
console.log(form);
  ...
  getCientById(id) {
    this.clientService.getClient(id)
      .subscribe((data: any) => {
        ...
        this.onGetAllClassificationSecteurs(this.client);
  ...
  onGetAllClassificationSecteurs(client) {
    this.secteurService.getAllClassificationSecteur()
      .subscribe((data: ClassificationSecteur[]) => {
        ...
        this.definitive = this.classifications.find(p=>p.code==client.clien_secteur_activite).libelle;
  ...
  onGetAllClassificationSecteursP() {
    this.secteurService.getAllClassificationSecteur()
      .subscribe((data: ClassificationSecteur[]) => {
        this.classifications = data as ClassificationSecteur[];
        this.definitive = this.classifications.find(p=>p.code==this.demandeSociete.dem_secteuractivites).libelle;
        console.log("definitivelibele",this.definitive)
