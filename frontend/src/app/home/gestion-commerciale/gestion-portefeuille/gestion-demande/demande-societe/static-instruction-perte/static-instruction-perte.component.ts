...
@Component({
  selector: 'ngx-static-instruction-perte',
  templateUrl: './static-instruction-perte.component.html',
  styleUrls: ['./static-instruction-perte.component.scss']
})
export class StaticInstructionPerteComponent implements OnInit {
  ...
  onExportConditionInstruction(demande:Dem_Soc) {
    ...
    if(this.demandeSociete.dem_produitdemande2==0){
      this.demandeSociete.dem_montant2=0;
    }
    if(this.demandeSociete.dem_produitdemande3==0){
      this.demandeSociete.dem_montant3=0;
    }
    ...
    this.produitpourcent2 =+'Number(this.demandeSociete.dem_montant2)* this.addForm.get("instruct_taux2").value/100';
    this.produitpourcent3 =+'Number(this.demandeSociete.dem_montant2)* this.addForm.get("instruct_taux3").value/100';
...
console.log(form);
    ...
    this.demSocService.generateReportInstructionPerte(demande.dem_socnum,form)
...
console.log(form);
  ...
  getAllAcheteurs(id,police) {
    
    this.acheteurService.getAllAcheteursByClientPolice(id,police)
      .subscribe((data: any) => {
        this.acheteurs = data as Acheteur[];
        for (let index in this.acheteurs) {
          console.log(index);
        }
        
        console.log(this.acheteurs,"acheteur",this.acheteurs.length);
        for(let i=0;i<this.acheteurs.length;i++)  {
          console.log(this.acheteurs[i],"ach");
          let ref: Locataire={
            nom: this.acheteurs[i].achet_nom.toString(),
            prenom : this.acheteurs[i].achet_prenom.toString(),
           };
