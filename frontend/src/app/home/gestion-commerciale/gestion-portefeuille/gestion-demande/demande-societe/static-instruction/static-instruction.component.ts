...
@Component({
  selector: 'ngx-static-instruction',
  templateUrl: './static-instruction.component.html',
  styleUrls: ['./static-instruction.component.scss'],
  //providers: [DatePipe]
})
export class StaticInstructionComponent implements OnInit {
  ...
  onExportConditionInstruction(demande:Dem_Soc) {
    ...
    form.append("montantavenent2", this.formatNumberService.numberWithCommas2(this.demandeSociete.dem_montant2)+"  FCFA");
		form.append("montantavenent3", this.formatNumberService.numberWithCommas2(this.demandeSociete.dem_montant3)+"  FCFA");
...
let message=""
    ...
    this.demSocService.generateReportInstruction1(demande.dem_socnum,form)
