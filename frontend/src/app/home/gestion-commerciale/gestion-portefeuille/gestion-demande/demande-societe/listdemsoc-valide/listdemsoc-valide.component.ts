...
@Component({
  selector: 'ngx-listdemsoc-valide',
  templateUrl: './listdemsoc-valide.component.html',
  styleUrls: ['./listdemsoc-valide.component.scss']
})
export class ListdemsocValideComponent implements OnInit {
  ...
  public displayedColumns = ['dem_socnum', 'dem_denomination', 'dem_typesociete', 'dem_nomprenomsdg',
   ...
   onGetAllDemandeSoc(){
    this.demSocService.getAllPresEmissionDemandeSociete()
