...
export class GestionClientComponent implements OnInit {
  ...
  onExport(format: String) {
    ...
    if (format === 'pdf') {
      ...
      this.clientService.generateReportClient(format, form)
        .subscribe(event => {
          switch (event.type) {
            ...
            case HttpEventType.Response:
              ...
              // window.open(fileURL) ;
              saveAs(event.body, 'liste des clients.pdf');
          }
        });
    }
        ...
        .subscribe(event => {
          switch (event.type) {
            ...
            case HttpEventType.Response:
              ...
              // var fileURL = URL.createObjectURL(event.body) ;
              // window.open(fileURL) ;
              saveAs(event.body, 'liste des clients.xlsx');
          }
        });
    }
  }
