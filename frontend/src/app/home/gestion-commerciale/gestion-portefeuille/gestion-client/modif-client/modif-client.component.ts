...
export class ModifClientComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log("nature: " + this.client.clien_nature);
    ...
    this.code_Civilite = this.client.clien_titre;
    ...
    // }
    this.code_typeSociete = this.client.clien_typesociete;
    ...
    */
    ...
    if (this.value_status == this.client_valide) {
      this.client_status = this.client_valide;

      this.problemeAfficheStatusValide = true;
      this.problemeAfficheStatusAttente = false;
      // this.value_status = "Valide" ;

      // Gerer RC et Ninea
      this.problemeAfficheNineaValide = true;
      this.problemeAfficheNineaAttente = false;

      this.problemeAfficheRCValide = true;
      this.problemeAfficheRCAttente = false;
    }
    if (this.value_status == this.client_attente) {
      this.client_status = this.client_attente;

      this.problemeAfficheStatusValide = false;
      this.problemeAfficheStatusAttente = true;

      // Gerer RC et Ninea
      this.problemeAfficheNineaValide = false;
      this.problemeAfficheNineaAttente = true;
      this.problemeAfficheRCValide = false;
      this.problemeAfficheRCAttente = true;

      if ((this.client.clien_ninea == null || this.client.clien_ninea == '') && (this.client.clien_registrecommerce == null || this.client.clien_registrecommerce == '')) {
        // console.log("Client en attente de Ninea et RC")
        this.attente_ninea_rc = true;
      }
      else {

        if (this.client.clien_ninea == null || this.client.clien_ninea == '') {
          // console.log("Client en attente de Ninea")
          this.attente_ninea = true;
        }

        if (this.client.clien_registrecommerce == null || this.client.clien_registrecommerce == '') {
          // console.log("Client en attente de RC")
          this.attente_rc = true;
        }
      }
    }
    */
    ...
    if (this.typePersonneChoisi == this.personneMorale) {
      ...
      if (this.typePersonneChoisi == this.personnePhysique && this.civiliteNature == this.gerant) {
        ...
        this.typeSociete = this.client.clien_typesociete;
        this.listTypeSociete = this.listTypeclient['TYPE_SOCIETE'];
        ...
        // this.modifForm.controls['clien_typesociete'].setValue(this.client.clien_typesociete);
        // this.code_typeSociete = this.client?.clien_typesociete?.toString();
        this.code_typeSociete2 = this.client?.clien_typesociete;

        // this.problemeAfficheCiviliteGerant = true;
        // this.problemeAfficheCivilite = false;
  ...
  submit() {
    ...
    // this.client_status = this.modifForm.get("clien_status").value;
    ...
    */
    ...
    // if (this.typePersonneChoisi === this.personnePhysique && this.nom === "") {
    //   this.problemeNom = true;
    //   this.erreur = true;
    // } else if (this.typePersonneChoisi === this.personnePhysique && this.prenom === "") {
    //   this.problemePrenom = true;
    //   this.erreur = true;
    // } else if (this.typePersonneChoisi === this.personneMorale && this.denomination === "") {
    //   this.problemeDenomination = true;
    //   this.erreur = true;
    // } else if (this.typePersonneChoisi === this.personneMorale && this.sigle === "") {
    //   this.problemeSigle = true;
    //   this.erreur = true;
    // }
    // else if (this.typePersonneChoisi === this.personneMorale && this.site === "") {
    //   this.problemeSite = true;
    //   this.erreur = true;
    // } else if (this.typePersonneChoisi === this.personneMorale && this.email === "") {
    //   this.problemeEmail = true;
    //   this.erreur = true;
    // } else if (this.typePersonneChoisi === this.personneMorale && this.registreCommerce === "") {
    //   this.problemeRC = true;
    //   this.erreur = true;
    // } else if (this.typePersonneChoisi === this.personneMorale && this.codeNinea === "") {
    //   this.problemeCodeNinea = true;
    //   this.erreur = true;
    // } else if (this.typePersonneChoisi === this.personneMorale && this.typeSociete === null) {
    //   this.problemeTypeSociete = true;
    //   this.erreur = true;
    // }

    // On vérifie qu'il n'y a pas de RC et Ninéa qui existe déjà
    // if (this.codeNinea != null && this.registreCommerce != null
    ...
    */
    ...
    /*
    else if (this.typePersonneChoisi == this.personnePhysique && this.civiliteNature == this.gerant) {

      this.civile = this.modifForm.get("clien_typesociete").value;
      this.listTypeSociete = this.listTypeclient['TYPE_SOCIETE'];
      this.typeSociete = (this.listTypeSociete.find(p => p.value == this.civile))?.id;

      this.modifForm.controls['clien_typesociete'].setValue(this.typeSociete);
      ...
      //   this.modifForm.controls['clien_status'].setValue(this.client_attente);
      // }

      // if((this.client_status !== null && this.client_status !== '') && (this.codeNinea == null || this.codeNinea == '' || this.registreCommerce == null || this.registreCommerce == '')){
      //   this.modifForm.controls['clien_status'].setValue(this.client_attente);
      // }

      // if (this.client_status == this.client_attente && (this.codeNinea == null || this.codeNinea == '') && this.registreCommerce != null && this.registreCommerce != '') {
      //   this.client_status = this.client_valide;
      // }
      ...
      // console.log("submit status: " + this.client_status);

      this.clientService.modifClient(this.modifForm.value)
        .subscribe((data) => {
          ...
          // if (this.client_status != null && this.client_status == this.client_valide) {
          //   this.router.navigateByUrl('/home/gestion-client')
          // } else if (this.client_status != null && this.client_status == this.client_attente) {
