...
export class GestionProspectComponent implements OnInit {
  ...
  onOpenAjout() {
    this.router.navigateByUrl('home/gestion-commerciale/gestion-portefeuille/prospects/ajout');
  }
  ...
  onOpenCompte(prospect: Prospect){
    this.transfertData.setData(prospect);
    this.router.navigateByUrl('home/ouverture-compte/societe');    
  }
  onOpenComptePh(prospect: Prospect){
    this.transfertData.setData(prospect);
    this.router.navigateByUrl('home/ouverture-compte/Physique');    
  }
  ...
  openProspectTansforme(){
    this.router.navigateByUrl('/home/gestion-commerciale/gestion-portefeuille/prospects-transformes');
  }
}
