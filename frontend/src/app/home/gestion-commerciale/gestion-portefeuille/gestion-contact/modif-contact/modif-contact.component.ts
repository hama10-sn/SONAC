...
@Component({
  selector: 'ngx-modif-contact',
  templateUrl: './modif-contact.component.html',
  styleUrls: ['./modif-contact.component.scss']
})
    ...
    .subscribe((token: NbAuthJWTToken) => {
     ...
     if (token.isValid()) {
       ...
       console.log(this.autorisation);
        ...
        this.clientnum = this.contact.cont_numeroclient;
        this.numero_client = this.contact.cont_numeroclient.toString();
        ...
        this.onchangeMail ();
        this.onchangeNumero();
        this.contactLeader(this.clientnum)
  }
