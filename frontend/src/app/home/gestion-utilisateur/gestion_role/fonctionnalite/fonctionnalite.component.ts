...
import { AjoutFonctionnaliteComponent } from './ajout-fonctionnalite/ajout-fonctionnalite.component';
import { ModifFonctionnaliteComponent } from './modif-fonctionnalite/modif-fonctionnalite.component';
...
export class FonctionnaliteComponent implements OnInit {
  ...
  public displayedColumns = ['entite', 'creer', 'modif', 'listing', 'sup'];
