...
@Component({
  selector: 'ngx-details-reglement-financier',
  templateUrl: './details-reglement-financier.component.html',
  styleUrls: ['./details-reglement-financier.component.scss']
})
export class DetailsReglementFinancierComponent implements OnInit {
