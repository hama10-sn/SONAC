...
@Component({
  selector: 'ngx-liste-reglement-financier',
  templateUrl: './liste-reglement-financier.component.html',
  styleUrls: ['./liste-reglement-financier.component.scss']
})
export class ListeReglementFinancierComponent implements OnInit {

  title = 'La liste des règlements Financiers';
  autorisation = [];
  ...
  public displayedColumns = ['client', 'police', 'produit', 'num_sinistre', 'num_mvtsinistre', /*'statut',*/ 'action'];
  ...
  ngOnInit(): void {
    this.onGetAllReglementFinancier();
    this.onGetAllClient();
  ...
  onGetAllReglementFinancier() {
    this.reglementService.getAllReglementFinancier()
      .subscribe((data: any) => {
  ...
  onChoixTypeReglement(sinistre: any){
  ...
  onDetailsReglementFinancier(sinistre: any) {
    this.transfertData.setData(sinistre);
    this.router.navigateByUrl('home/gestion-comptable/gestion-reglement-financier/liste-reglement-financier/details');
  }

  openListeReglementValides(){
    this.router.navigateByUrl('home/gestion-comptable/gestion-reglement-financier');
  }

  onExportReglementFinancier(sinistre) {
    ...
    console.log(sinistre);
      ...
      this.reglementService.generateEditionFicheReglementFinancier(sinistre.sini_num, sinistre.mvts_num, form)
        .subscribe(event => {
          switch (event.type) {
