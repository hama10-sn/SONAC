...
@Component({
  selector: 'ngx-annulation-encaissement-recours',
  templateUrl: './annulation-encaissement-recours.component.html',
  styleUrls: ['./annulation-encaissement-recours.component.scss']
})
export class AnnulationEncaissementRecoursComponent implements OnInit {
  ...
  onAnnulationValidationRecoursEncaisse(mvts: Mvtsinistre) {
    this.sinistreService.getSinistreByNumero(mvts.mvts_numsinistre)
      .subscribe((data: any) => {
        let sinistre = data.data;
