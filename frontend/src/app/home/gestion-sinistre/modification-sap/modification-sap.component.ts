...
@Component({
  selector: 'ngx-modification-sap',
  templateUrl: './modification-sap.component.html',
  styleUrls: ['./modification-sap.component.scss']
})
export class ModificationSapComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.mySinistreForm.get('mvtsinistreForm.mvts_montantprincipal').setValue(this.sinistre.sini_sapprincipale);
    this.ancienMontantPrincipal = this.formatNumberService.numberWithCommas2(this.sinistre.sini_sapprincipale);

    this.mySinistreForm.get('mvtsinistreForm.mvts_montantfrais').setValue(this.sinistre.sini_sapfrais);
    this.ancienMontantFrais = this.formatNumberService.numberWithCommas2(this.sinistre.sini_sapfrais);

    this.mySinistreForm.get('mvtsinistreForm.mvts_montanthonoraire').setValue(this.sinistre.sini_saphonoraires);
    this.ancienMontantHonoraire = this.formatNumberService.numberWithCommas2(this.sinistre.sini_saphonoraires);
  ...
  onSubmit() {
    ...
    this.sinistreService.modificationSAPSinistre(this.mySinistreForm.value)
      .subscribe((data: any) => {
        if (data.code === "ok") {
          ...
          this.router.navigateByUrl('home/gestion-sinistre/modification-sap/view');
