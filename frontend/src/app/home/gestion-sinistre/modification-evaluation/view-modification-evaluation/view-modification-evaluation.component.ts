...
@Component({
  selector: 'ngx-view-modification-evaluation',
  templateUrl: './view-modification-evaluation.component.html',
  styleUrls: ['./view-modification-evaluation.component.scss']
})
export class ViewModificationEvaluationComponent implements OnInit {
  ...
  onExport() {
    ...
    this.sinistreService.generateEditionFicheModificationEvaluation(demandeurNew, this.documentFinale, this.sinistreFront)
      .subscribe(event => {
        switch (event.type) {
          ...
          case HttpEventType.Response:
            saveAs(event.body, 'Modification évaluation.pdf');
        }
      });
  }
