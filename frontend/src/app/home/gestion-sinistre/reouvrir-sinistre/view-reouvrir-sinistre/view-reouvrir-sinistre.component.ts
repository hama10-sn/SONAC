...
@Component({
  selector: 'ngx-view-reouvrir-sinistre',
  templateUrl: './view-reouvrir-sinistre.component.html',
  styleUrls: ['./view-reouvrir-sinistre.component.scss']
})
export class ViewReouvrirSinistreComponent implements OnInit {
  ...
  onExport() {
    ...
    this.sinistreService.generateFicheReouvertureSinistre(demandeurNew, this.recoursFront)
      .subscribe(event => {
        switch (event.type) {
          ...
          case HttpEventType.Response:
            saveAs(event.body, 'réouverture sinistre.pdf');
        }
    });
  }
