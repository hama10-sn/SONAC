...
@Component({
  selector: 'ngx-validation-recours',
  templateUrl: './validation-recours.component.html',
  styleUrls: ['./validation-recours.component.scss']
})
export class ValidationRecoursComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.myValidationForm.get('mvtsinistreForm.mvts_typemvt').setValue(10);
  ...
  onSubmit() {
    ...
    this.recoursService.validationRecours(this.sinistre.sini_num, this.myValidationForm.value)
      .subscribe((data: any) => {
        if (data.code === "ok") {
          ...
          this.router.navigateByUrl('home/gestion-sinistre/veiw-encaissement-recours');
