...
@Component({
  selector: 'ngx-view-proposition-recours',
  templateUrl: './view-proposition-recours.component.html',
  styleUrls: ['./view-proposition-recours.component.scss']
})
export class ViewPropositionRecoursComponent implements OnInit {
  ...
  onExport() {
    ...
    this.recoursService.generateFichePropositionRecours(demandeurNew, this.recoursFront)
      .subscribe(event => {
        switch (event.type) {
          ...
          case HttpEventType.Response:
            saveAs(event.body, 'proposition de recours.pdf');
        }
    });
  }
