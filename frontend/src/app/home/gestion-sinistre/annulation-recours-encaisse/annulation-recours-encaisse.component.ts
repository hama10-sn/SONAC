...
@Component({
  selector: 'ngx-annulation-recours-encaisse',
  templateUrl: './annulation-recours-encaisse.component.html',
  styleUrls: ['./annulation-recours-encaisse.component.scss']
})
export class AnnulationRecoursEncaisseComponent implements OnInit {
