...
@Component({
  selector: 'ngx-facture-annuler',
  templateUrl: './facture-annuler.component.html',
  styleUrls: ['./facture-annuler.component.scss']
})
export class FactureAnnulerComponent implements OnInit {
  ...
  onGetAllaFacture(){
    this.factService.getAllFacturesAnnul()
