...
@Component({
  selector: 'ngx-consultation-encaissement-annule',
  templateUrl: './consultation-encaissement-annule.component.html',
  styleUrls: ['./consultation-encaissement-annule.component.scss']
})
export class ConsultationEncaissementAnnuleComponent implements OnInit {
  ...
  title = 'La liste des encaissements annulés (par ordre de numéro)';
  ...
  ngOnInit(): void {
    ...
    this.onGetAllEncaissementsAnnules() ;
  ...
  */
  ...
  onGetAllEncaissementsAnnules() {
    this.encaissementService.getAllEncaissementsAnnules()
      .subscribe((data: any) => {
        this.dataSource.data = data;
      });
  }

  onGetAllEncaissementsAnnulesByPeriode(dateDebut: string, dateFin: string) {
    this.encaissementService.getAllEncaissementsAnnulesByPeriode(dateDebut, dateFin)
      .subscribe((data: any) => {
        this.dataSource.data = data;
      });
  }

  onGetAllEncaissementsAnnulesByProduit(numProd: number) {
    this.encaissementService.getAllEncaissementsAnnulesByProduit(numProd)
      .subscribe((data: any) => {
        this.dataSource.data = data;
      });
  }

  onGetAllEncaissementsAnnulesByIntermediaire(numInterm: number) {
    this.encaissementService.getAllEncaissementsAnnulesByIntermediaire(numInterm)
      .subscribe((data: any) => {
        this.dataSource.data = data;
      });
  }

  onGetAllEncaissementsAnnulesByPeriodeAndProduit(numProd: number, date_debut: string, date_fin: string) {
    this.encaissementService.getAllEncaissementsAnnulesByPeriodeAndProduit(numProd, date_debut, date_fin)
      .subscribe((data: any) => {
        this.dataSource.data = data;
      });
  }

  onGetAllEncaissementsAnnulesByPeriodeAndIntermediaire(numInterm: number, date_debut: string, date_fin: string) {
    this.encaissementService.getAllEncaissementsAnnulesByPeriodeAndIntermediaire(numInterm, date_debut, date_fin)
      .subscribe((data: any) => {
        this.dataSource.data = data;
      });
  }

  onGetAllEncaissementsAnnulesByProduitAndIntermediaire(numInterm: number, numProd: number) {
    this.encaissementService.getAllEncaissementsAnnulesByProduitAndIntermediaire(numInterm, numProd)
      .subscribe((data: any) => {
        this.dataSource.data = data;
      });
  }

  onGetAllEncaissementsAnnulesByCriteres(numInterm: number, numProd: number, date_debut: string, date_fin: string) {
    this.encaissementService.getAllEncaissementsAnnulesByCriteres(numInterm, numProd, date_debut, date_fin)
      .subscribe((data: any) => {
        this.dataSource.data = data;
      });
  }
  ...
  */
  ...
  onConsulter() {
    ...
    if((this.date_debut != '0' && this.date_debut !== '') && (this.date_fin != '0' && this.date_fin !== '') && this.numProduit == 0 && this.numIntermediaire == 0) {
      this.onGetAllEncaissementsAnnulesByPeriode(this.date_debut, this.date_fin) ;
      this.title = 'La liste des encaissements annulés (par période)';
    } else if (this.numProduit != 0 && this.numIntermediaire == 0 && (this.date_debut == '0' || this.date_debut === '') && (this.date_fin == '0' || this.date_fin === '')) {
      this.onGetAllEncaissementsAnnulesByProduit(this.numProduit);
      this.title = 'La liste des encaissements annulés (par produit)';

    } else if (this.numProduit == 0 && this.numIntermediaire != 0 && (this.date_debut == '0' || this.date_debut === '') && (this.date_fin == '0' || this.date_fin === '')) {
      this.onGetAllEncaissementsAnnulesByIntermediaire(this.numIntermediaire);
      this.title = 'La liste des encaissements annulés (par intermédiaire)';

    } else if ((this.date_debut != '0' && this.date_debut !== '') && (this.date_fin != '0' && this.date_fin !== '') && this.numProduit != 0 && this.numIntermediaire == 0) {
      this.onGetAllEncaissementsAnnulesByPeriodeAndProduit(this.numProduit, this.date_debut, this.date_fin);
      this.title = 'La liste des encaissements annulés (par période et produit)';

    } else if ((this.date_debut != '0' && this.date_debut !== '') && (this.date_fin != '0' && this.date_fin !== '') && this.numProduit == 0 && this.numIntermediaire != 0) {
      this.onGetAllEncaissementsAnnulesByPeriodeAndIntermediaire(this.numIntermediaire, this.date_debut, this.date_fin);
      this.title = 'La liste des encaissements annulés (par période et intermédiaire)';

    } else if (this.numProduit != 0 && this.numIntermediaire != 0 && (this.date_debut == '0' || this.date_debut === '') && (this.date_fin == '0' || this.date_fin === '')) {
      this.onGetAllEncaissementsAnnulesByProduitAndIntermediaire(this.numIntermediaire, this.numProduit);
      this.title = 'La liste des encaissements annulés (par produit et intermédiaire)';

    } else if (this.numProduit != 0 && this.numIntermediaire != 0 && (this.date_debut != '0' && this.date_debut !== '') && (this.date_fin != '0' && this.date_fin !== '')) {
      this.onGetAllEncaissementsAnnulesByCriteres(this.numIntermediaire, this.numProduit, this.date_debut, this.date_fin);
      this.title = 'La liste des encaissements annulés (par période, produit et intermédiaire)';
    } else {
      this.onGetAllEncaissementsAnnules();
      this.title = 'La liste des encaissements annulés (par ordre de numéro)';
    }
  ...
  onExport(format: String) {
    ...
    if (format === 'pdf') {
      this.encaissementService.generateReportEncaissementsAnnules(format, titleNew, demandeurNew, this.numIntermediaire, this.numProduit, this.date_debut, this.date_fin)
        .subscribe(event => {
          switch (event.type) {
            ...
            case HttpEventType.Response:
              saveAs(event.body, 'liste des encaissements annulés.pdf');
          }
        });
    }

    if (format === 'excel') {
      this.encaissementService.generateReportEncaissementsAnnules(format, this.title, this.demandeur, this.numIntermediaire, this.numProduit, this.date_debut, this.date_fin)
        .subscribe(event => {
          switch (event.type) {
            case HttpEventType.Sent:
              console.log('Request has been made!');
            ...
            case HttpEventType.Response:
              ...
              // window.open(fileURL) ;
              saveAs(event.body, 'liste des encaissements annulés.xlsx');
          }
        });
    }
  }
