...
/* onGetProduitByPolice(engagement: any){
  ...
  submit() { 
    ...
    //this.addForm.controls['engag_cautionsolidaire'].setValue();
    this.addForm.controls['engag_kapassure'].setValue(this.formatcapitalassure);
    console.log(this.addForm.controls['engag_kapassure'].value);
    this.addForm.controls['engag_codeutilisateur'].setValue(this.user.util_numero);
    this.engagementService.addEngagement(this.addForm.value)
    .subscribe((data) => {
      console.log(data);
    ...
    (error) => {
      ...
      onChangePolice(event) {
        this.addForm.controls['engag_numpoli'].setValue(event.value);
...
/* this.policeService.getLastAvenantByPolice(event.value).subscribe((data)=>{
    ...
    this.addForm.controls['engag_numeroavenant'].setValue(event.value +1);
...
if(((this.polices.find(p => p.poli_numero == event.value))?.poli_branche) === 15){
  ...
  this.displayProd = true
        ...
        this.addForm.controls['engag_dateengagement'].setValue(this.dateEngagement);
        ...
        this.addForm.controls['engag_dateliberation'].setValue(this.echeance); 
        ...
        //this.addForm.controls['engag_cautionsolidaire'].setValue((this.listTypeCausions1.filter(p => p.id == '1')));
       // console.log(this.listTypeCausions);
        }else if(this.onGetTypeByClient(this.souscripteur) == '2'){
          
        this.listTypeCausions1=this.types['TYPE_CAUTION_SOLIDAIRE'];
        this.listTypeCausions=this.listTypeCausions1.filter(p => p.id == '2')
        //this.addForm.controls['engag_cautionsolidaire'].setValue((this.listTypeCausions1.filter(p => p.id == '2')));
      ...
      onChangeFocus(event: any){
        console.log(this.dateEcheance);
        this.deposite=this.addForm.controls['engag_datedeposit'].value;
        ...
        if( dateFormatter(this.deposite, 'yyyy-MM-dd') >= dateFormatter(this.effet, 'yyyy-MM-dd') && dateFormatter(this.dateEcheance, 'yyyy-MM-dd') >= dateFormatter(this.deposite, 'yyyy-MM-dd') ){
          ...
          this.addForm.controls['engag_datedeposit'].setValue("");
        }
      }
      ...
      onChangeFocusEngagementEffet(event: any){
        ...
        if( dateFormatter(this.dateEng, 'yyyy-MM-dd') >= dateFormatter(this.effet, 'yyyy-MM-dd') && dateFormatter(this.dateEcheance, 'yyyy-MM-dd') >= dateFormatter(this.dateEng, 'yyyy-MM-dd') ){
          ...
          //console.log("dou bou baxbi");
          this.addForm.controls['engag_dateengagement'].setValue("");
      ...
      onChangeType(event) {
        ...
        this.addForm.controls['engag_typesurete'].setValue(event.value);

         if(event.value == '1'){
           this.displaytype=true;
           this.displaytypedepo=false;
           this.displayCaution=false;
          this.addForm.controls['engag_identificationtitre'].setValidators(Validators.required);
          this.addForm.controls['engag_retenudeposit'].clearValidators();
          this.addForm.controls['engag_datedeposit'].clearValidators();
          this.addForm.controls['engag_cautionsolidaire'].clearValidators();
        }else if(event.value == '2'){
          this.displaytypedepo=true;
          this.displaytype=false;
          this.displayCaution=false;
          this.addForm.controls['engag_identificationtitre'].clearValidators();
          this.addForm.controls['engag_retenudeposit'].setValidators(Validators.required);
          this.addForm.controls['engag_datedeposit'].setValidators(Validators.required);
          this.addForm.controls['engag_cautionsolidaire'].clearValidators();
          ...
          this.displaytype=false;
          this.displaytypedepo=false;
         this.addForm.controls['engag_cautionsolidaire'].setValidators(Validators.required);
         this.addForm.controls['engag_retenudeposit'].clearValidators();
         this.addForm.controls['engag_datedeposit'].clearValidators();
         this.addForm.controls['engag_identificationtitre'].clearValidators();
        ...
        //console.log(this.addForm.controls['engag_identificationtitre'].value);
        this.addForm.controls['engag_identificationtitre'].updateValueAndValidity();
        this.addForm.controls['engag_retenudeposit'].updateValueAndValidity();
        this.addForm.controls['engag_datedeposit'].updateValueAndValidity();
        this.addForm.controls['engag_cautionsolidaire'].updateValueAndValidity();
      }
      onChangeActe(event) {

        this.addForm.controls['engag_numeroacte'].setValue(event.value);
        this.engagementService.lastID(event.value).subscribe((data)=>{
          if(data==0){
            this.addForm.controls['engag_numeroengagement'].setValue(event.value.toString()+"000001");
          }else{
            this.addForm.controls['engag_numeroengagement'].setValue(Number(data)+1);
          }
        })
      }
      onChangeMarche(event) {

        this.addForm.controls['engag_codemarche'].setValue(event.value);
      }
      onChangeCaution(event) {
        this.addForm.controls['engag_cautionsolidaire'].setValue(event);
        console.log(event);
      }
      onChangeAvenant(event) {
        this.addForm.controls['engag_numeroavenant'].setValue(event.value);
      }

      onChange(event) {
        this.addForm.controls['engag_status'].setValue(event);
      }
