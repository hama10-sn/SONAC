...
@Component({
  selector: 'ngx-liberation-autres-suretes',
  templateUrl: './liberation-autres-suretes.component.html',
  styleUrls: ['./liberation-autres-suretes.component.scss']
})
export class LiberationAutresSuretesComponent implements OnInit {
