...
@Component({
  selector: 'ngx-liberation-caution-solidaire',
  templateUrl: './liberation-caution-solidaire.component.html',
  styleUrls: ['./liberation-caution-solidaire.component.scss']
})
export class LiberationCautionSolidaireComponent implements OnInit {
