...
@Component({
  selector: 'ngx-realisation-caution-solidaire',
  templateUrl: './realisation-caution-solidaire.component.html',
  styleUrls: ['./realisation-caution-solidaire.component.scss']
})
export class RealisationCautionSolidaireComponent implements OnInit {
