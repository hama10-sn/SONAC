...
@Component({
  selector: 'ngx-liberation-tf',
  templateUrl: './liberation-tf.component.html',
  styleUrls: ['./liberation-tf.component.scss']
})
export class LiberationTFComponent implements OnInit {
