...
@Component({
  selector: 'ngx-police-reprise',
  templateUrl: './police-reprise.component.html',
  styleUrls: ['./police-reprise.component.scss']
})
export class PoliceRepriseComponent implements OnInit {
...
onChangeNumPR(event) {
  ...
  findContrat2() {
    ...
    this.router.navigateByUrl('home/reprise-production/police/ajout-police');
