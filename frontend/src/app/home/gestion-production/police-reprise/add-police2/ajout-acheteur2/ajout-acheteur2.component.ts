...
@Component({
  selector: 'ngx-ajout-acheteur2',
  templateUrl: './ajout-acheteur2.component.html',
  styleUrls: ['./ajout-acheteur2.component.scss']
})
export class AjoutAcheteur2Component implements OnInit {
  ...
  acheteur:FormGroup = this.fb.group({
    ...
    achet_montantecheancecredit: ['', Validators.required],
    ...
    constructor(protected ref: NbDialogRef<AjoutAcheteur2Component>,private fb: FormBuilder,
