...
@AllArgsConstructor
@Entity
@Table(name = "facture_P" )



public class Facture_P implements Serializable{
	...
	//  @GeneratedValue(strategy = GenerationType.IDENTITY)
	  ...
	  private int active;
	public Facture_P(Long fact_numacte, Date fact_datefacture, Long fact_numeropolice, Long fact_numeroacte,
