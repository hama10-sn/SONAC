...
@Table(name = "risque_P")
 @NoArgsConstructor
 @Data
public class Risque_P implements Serializable{
	...
	public Risque_P(Long risq_numeropolice, Long risq_numero, Long risq_numeroacte, String risq_typerisque,
