...
@Entity
@Table(name = "avenant_P")
 @NoArgsConstructor
 @Data
public class Avenant_P implements Serializable{
	...
	public Avenant_P(Long aven_numeropolice, Long aven_codeintermediare, String aven_codecompagnie, Long aven_codemarche,
	...
	public Avenant_P(Police_P p,Long type,String user) {
		super();
