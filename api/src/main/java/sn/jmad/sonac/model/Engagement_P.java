...
@AllArgsConstructor
@Entity
@Table(name = "engagement_P" )



public class Engagement_P implements Serializable{
	...
	//  @GeneratedValue(strategy = GenerationType.IDENTITY)
	  ...
	  private int active;
	public Engagement_P(Long engag_numeroengagement, Long engag_numpoli, Long engag_numeroavenant, Long engag_numeroacte,
	...
	public Engagement_P(PoliceForm p) {
		//super()();
