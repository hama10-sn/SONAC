...
@AllArgsConstructor
@Entity
@Table(name = "beneficiaire_P")

public class Beneficiaire_P implements Serializable{
	...
	public Beneficiaire_P(Long benef_Num, String benef_typbenef, String benef_nom, String benef_prenoms,
	...
	public Beneficiaire_P(PoliceForm p) {
		//super();
